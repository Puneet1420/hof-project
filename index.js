...
console.log("Test URL 1:", isValidURL(testURL1)); // Should print true
console.log("Test URL 2:", isValidURL(testURL2)); // Should print true
console.log("Test URL 3:", isValidURL(testURL3)); // Should print false
